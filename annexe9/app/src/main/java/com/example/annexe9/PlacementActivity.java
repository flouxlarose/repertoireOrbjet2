...
public class PlacementActivity extends AppCompatActivity {
    ...
    private class Ecouteur implements View.OnClickListener {
        ...
        public void onClick(View source) {
            try {
                Placement placement = new Placement(Integer.parseInt(champMontant.getText().toString()), numberPicker.getValue() * 12);
                labelReponse.setText(String.valueOf(d.format(placement.calculerMontantFinal())));
            } catch (NumberFormatException nfe) {
                creerAlertDialog("INVALID : NumberFormatException");
